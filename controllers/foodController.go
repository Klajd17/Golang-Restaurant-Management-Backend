...
func GetFoods() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		result, err := foodCollections.Aggregate(ctx, mongo.Pipeline{matchStage, groupStage, projectStage})
		defer cancel()
		if err != nil {
...
func GetFood() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err := foodCollections.FindOne(ctx, bson.M{"food_id": foodId}).Decode(&food)
		defer cancel()
		if err != nil {
...
func CreateFood() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		result, insertErr := foodCollections.InsertOne(ctx, food)
		if insertErr != nil {
...
func UpdateFood() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		result, err := foodCollections.UpdateOne(ctx, filter, bson.D{{"$set", updateObj}}, &opt)
		if err != nil {
